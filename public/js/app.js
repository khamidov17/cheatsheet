...
/**
 * Debounce a function call to improve performance on frequent events.
 * Expected impact: Reduces network requests by up to 90% during active typing.
 */
...
async function saveHistoryInternal() {
    ...
    // Only update history grid if landing view is visible
...
/**
 * Debounced saveHistory to prevent excessive API calls while typing.
 */
...
// Flush any pending saves before the page is unloaded
