...
/**
 * Optimized history persistence with 1s debounce to reduce server load
 * and keepalive to ensure data is saved even if user leaves.
 */
...
async function createBlankCheatsheet() {
