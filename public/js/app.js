 ...
 * Performance Optimization: Debounces the saveHistory API call to 1000ms to reduce
 * server load and improve editor responsiveness during active typing.
 * @param {boolean} [immediate=false] - If true, flushes the save immediately and updates the history UI.
 */
    ...
    if (doc) {
        ...
        if (immediate) {
            ...
            saveTimeout = setTimeout(() => {
                saveHistory();
                // We keep the history UI update out of the frequent debounce path
                // to further reduce main thread DOM overhead.
            }, 1000);
        }
    }
}
