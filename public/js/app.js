...
const debouncedSaveHistory = debounce(() => {
    saveHistory();
    // Only render history if we are not currently typing (to avoid UI jumps)
    // We can't easily tell if we're typing here without extra state,
    // but typically history is at the bottom or separate view.
    renderHistory();
}, 1000);
