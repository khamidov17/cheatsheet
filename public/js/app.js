 ...
 * Implementation captures 'this' and supports .flush() for immediate execution.
 */
 ...
 * Optimizes performance by using Promise.all for parallel API requests.
 */
 ...
 * Reduces network traffic during active editing sessions.
 */
const debouncedSaveHistory = debounce(saveHistoryInternal, 1000);

/**
 * Public wrapper for history saving.
 * Use force=true for critical actions like creation, deletion or navigation.
 */
 ...
 * Optimizes performance by using debounced persistence and skipping UI refresh if background.
 */
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Ensure any pending debounced history saves are flushed before user exits
