 ...
 * Performance impact: Reduces API calls during rapid typing by ~95%.
 */
...
async function saveHistoryInternal() {
    ...
    // Only re-render history grid if landing view is visible
...
/**
 * Debounced version of saveHistoryInternal to reduce API overhead.
 */
 ...
 * @param {boolean} immediate - If true, bypass debounce for critical state changes.
 */
...
// Ensure pending changes are saved before navigation
