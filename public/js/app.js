 ...
 * Performance: Debouncing reduces API calls by ~90% during active typing (from ~10 calls/sec to 1 call/sec).
 */
function _saveCurrentDocument(immediate = true) {
...
const debouncedSave = debounce(() => _saveCurrentDocument(false), 1000);
...
function renderCanvasNodes() {
    ...
    window.appState.canvasData.forEach((section, idx) => {
        ...
        content.addEventListener('input', () => {
            ...
            saveCurrentDocument(false); // Debounced save for typing
        });
